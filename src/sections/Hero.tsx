...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex flex-col items-center pt-24 pb-32 lg:pt-0 lg:pb-0 px-6 overflow-hidden bg-brand-bg">
...
function Ticker() {
  ...
  return (
    <div className="absolute bottom-20 sm:-bottom-6 left-0 w-[150%] -translate-x-[10%] bg-brand-primary py-5 sm:py-8 overflow-hidden border-y-[4px] sm:border-y-[6px] border-brand-dark rotate-[-1.5deg] z-30 shadow-2xl">
      <motion.div
        animate={{ x: [0, -1500] }}
